...
- [RoseAP PartI SoftwareInstallation](https://www.youtube.com/watch?v=npqQ6tkVAN0) is demonstrating what is explained in this section : [installation in windows](https://js2sf.readthedocs.io/en/latest/getting-started.html#installation-in-windows)
